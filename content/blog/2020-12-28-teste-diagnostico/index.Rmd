...
categories: ['Bioestatística', 'Estatística teórica']
tags: ['como mentir com estatística', 'teorema de Bayes']
comments: yes
summary: 'Já se perguntou qual a probabilidade do seu teste diagnóstico ser um positivo verdadeiro? Nesse post, discuto essa resposta. E ela não é nada intuitiva: depende de quem você é.'
output:
  blogdown::html_page:
    toc: false
---
