...
tags: ['gráficos', 'estatística teórica']  
comments: yes
summary: 'Esse é um teste da descrição do post :)'
output:
  blogdown::html_page:
    toc: true
toc-title: "Tópicos neste post:"
---
...
> Se os conceitos de população, amostra e inferência estatística não estão muito claros para você, recomendo a leitura desse [texto](https://fernandafperes.com.br/intervalo-de-confianca/). 
...
```{r, echo=FALSE, fig.align='center', out.width = '285px'}
knitr::include_graphics("images/Img3.png", error = FALSE)
```
...
O valor de p (valor de probabilidade, discutido [aqui](https://fernandafperes.com.br/uma-doutora-toma-cha/)) pode ser calculado a partir do valor de p. Como?  
...
Por mais extremo, devemos entender o seguinte: caso t seja positivo (como na figura abaixo), o valor de p corresponde à probabilidade de obtermos um valor de t igual àquele ou ainda superior; caso t seja negativo, o valor de p será a proabilidade de obtermos um valor de t igual àquele ou ainda menor ("mais negativo").
...
Está aí um dos conceitos de estatística mais difíceis de definir, na minha opinião. Então, uma explicação detalhada está fora do escopo desse post.  
...
Como já discutimos no post [Uma doutora toma chá](https://fernandafperes.com.br/uma-doutora-toma-cha), o nível de significância ($\alpha$) é o nosso ponto de corte para o valor de p. Esse ponto de corte deve ser definido *a priori*, ou seja, antes das análises dos dados iniciarem.  
