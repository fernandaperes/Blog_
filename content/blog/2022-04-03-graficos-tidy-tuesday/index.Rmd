...
Ah, se você não sabe o que é a #TidyTuesday, eu explico melhor no meu [post anterior](https://fernandafperes.com.br/tidytuesday-emmy/).  
...
```{r, echo = FALSE}
knitr::kable(tbl_sum %>% select(decade, female, male, prop.f, estimated.sex) %>% 
