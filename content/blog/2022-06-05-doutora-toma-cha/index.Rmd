...
comments: yes
summary: 'Uma discussão sobre valor de p, teste de hipóteses e nível de significância. Afinal, o que o valor de p – essa medida tão famosa e tão controversa – indica? Nesse post, te explico esses conceitos com base no experimento "uma senhora toma chá".'
output:
  blogdown::html_page:
    toc: false
---
...
```
<font size = '2'>Estação experimental agrícola de Rothamsted</font>
