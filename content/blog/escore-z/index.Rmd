...
>A gente cosnegue obter esse valor a partir de tabelas para a distribuição normal padrão, como [esta](https://www.ime.unicamp.br/~cnaber/tabela_normal.pdf). Mas você também pode calculá-la usando a seguinte formula em R:  
>  
>`1-pnorm(q = 2.2)`  
>  
