...
tags: ['valor de p', 'nível de significância']
comments: yes
...
> Se o conceito de valor de p ainda não está muito claro para você, recomendo a leitura de outros exemplos [aqui](https://fernandafperes.com.br/uma-doutora-toma-cha/) e [aqui](https://fernandafperes.com.br/valor-de-p-calculo/).  
...
Em tradução livre: "A falha em compreender que a hipótese nula é sempre considerada verdadeira é responsável pelas falácias da probabilidade do acaso e da probabilidade inversa. Especificamente, como assume-se que a hipótese nula verdadeira, a amostragem aleatória (ou seja, o acaso) é a única explicação para qualquer resultado".
...
Você encontra uma ótima discussão sobre a replicabilidade do valor de p nesse artigo do Cummings[efn_note]Cumming, G. (2008). Replication and p intervals: p values predict the future only vaguely, but confidence intervals do much better. Perspectives on psychological science, 3(4), 286-300.[/efn_note]. Spoiler: a replicabilidade do valor de p é **bem baixa**.  
