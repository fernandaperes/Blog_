...
comments: yes
summary: 'Já se perguntou qual é a probabilidade real de ganhar na Mega-Sena? Neste post, eu explico de onde vem esse número, como a probabilidade muda quando fazemos mais apostas ou apostamos em mais números, e o porquê aumentar a probabilidade de ganhar não significa, necessariamente, sair no lucro.'
output:
  blogdown::html_page:
    toc: false
editor_options: 
...
```{r, include=FALSE}
# https://pt.linkedin.com/pulse/prevendo-n%C3%BAmeros-da-mega-sena-com-intelig%C3%AAncia-e-wagner-fonseca-souza-lnj7f
