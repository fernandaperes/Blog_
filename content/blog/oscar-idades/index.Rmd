...
<div class = "faq">
<center>
*Michelle Yeoh, vencedora do Oscar de Melhor atriz na ceromônia de 2023, aos 60 anos.*
</center>
</div></div>
...
Esse último argumento me incomodou particularmente. Com certeza existem mulheres que foram premiadas mais velhas, acima dos 50 ou 60 anos. Mas, a existência dessas premiações não é **evidência suficiente para rejeitar a hipótese** em questão: em geral (e aqui vamos pensar "em média") as muheres que são premiadas nas categorias de melhor atriz são mais jovens que os homens premiados nas categorias de melhor ator.  
...
write.csv2("Dados_Oscar_Fernanda_Peres.csv")
```
  
#### Qual a média de idade dos homens e mulheres que vencem nas categorias de atuação?
  
A média de idade ao receber o prêmio de melhor atriz, durante todo o período (1927 a 2025) foi de **36,9 anos** (*versus* **44,6 anos** para melhor ator). Esse padrão se mantém quando olhamos para a mediana: 33,5 anos para as mulheres e 43 anos para os homens. Isso mostra que os **homens** que ganham o prêmio máximo de atuação são, em geral, **mais velhos** que as mulheres.  
  
Quando avaliamos os prêmios de atrizes e atores coadjuvantes, novamente a média de idade das mulheres é menor: **40,9 anos** *versus* **49,8 anos**. A mediana, mais uma vez, segue a tendência da média. Em mediana, as atrizes coadjuvantes vencedoras têm 39 anos, enquanto os atores coadjuvantes têm 46 anos.  
