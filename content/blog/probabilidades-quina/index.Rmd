...
Para conseguirmos pensar na probabilidade de uma pessoa ganhar na Quina, o primeiro passo é calcular quantos sorteios diferentes podem existir. Perceba que são sempre sorteados **5 números em 50**, e a **ordem** dos números sorteados **não importa** (ou seja, 1-2-3-4-5 é a mesma coisa que 5-4-3-2-1).  
