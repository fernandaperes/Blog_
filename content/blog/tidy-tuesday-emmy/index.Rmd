...
```{r, echo=FALSE, fig.align='center', out.width = '300px', fig.cap="Eu mesma, nesse último mês"}
...
Portanto, valores acima de 1 indicam que, naquela distribuidora, mais mulheres foram indicadas a categorias de atuação que homens. Valores abaixo de 1, significam que mais homens foram indicados. A distribuidora Hulu se destaca com a maior proporção de mulheres indicadas, em relação aos homens - o que provavelmente se deve a The Handmaid's Tale. Já a Showtime é a distribuidora com a maior proporção de homens indicados, em relação a mulheres.
