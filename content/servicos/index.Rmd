...
razao_fechamento <- "Oi! Essa semana estou finalizando as análises dos últimos clientes do ano e, por isso, a agenda está fechada para novas contratações. Estarei em recesso a partir do dia 21/12 e tirarei duas semanas de férias em janeiro. A agenda para contratação dos serviços de análise dados ou consultoria ficará **fechada** durante esse período."
